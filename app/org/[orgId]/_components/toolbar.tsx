...
import {ToolButton} from "@/app/org/[orgId]/_components/tool-button";
...
const Toolbar = ({
    ...
    return (
        <div className="absolute top-[50%] -translate-y-[50%] left-2 flex flex-col gap-y-4">
            <div className="bg-white roundend-md p-1.5 flex gap-y-1 flex-col items-center shadow-md">
                ...
                />
                <ToolButton label="Pencil" icon={Pencil} onClick={() => setCanvasState({
